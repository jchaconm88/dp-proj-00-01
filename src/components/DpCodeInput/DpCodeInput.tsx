 ...
 * Usar sequenceService.resolveCodeIfEmpty(code, entity) al guardar para obtener el código final.
 */
export default function DpCodeInput({
  entity,
  value,
  onChange,
  label = "Código",
